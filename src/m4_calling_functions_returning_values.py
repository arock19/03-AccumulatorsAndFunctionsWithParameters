...
def run_test_sum_of_digits():
    ...
    # ------------------------------------------------------------------
    # TO: 2. Implement this TEST function, as follows:
    #
...
def run_test_digits_in_power():
    ...
    # Test 1:
    expected = 1
    answer = digits_in_power(1,23678)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    # Test 2:
    expected = 27
    ...
    # Test 3:
    expected = 1
    answer = digits_in_power(23678,0)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
